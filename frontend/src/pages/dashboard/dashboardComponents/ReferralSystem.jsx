          ...
          <CardActionArea disableRipple>
            ...
            <CardContent>
              ...
              >
                <TextField
                  value={
                    "http://TraderConnects.net/auth/register"
                  }
            ...
            >
                <Button
                  ...
                  color="secondary"
                  onClick={() =>
                    handleCopyReferralLinkMobile("http://TraderConnects.net/auth/register")
                  }
                >
                  Copy Link
                </Button>
        ...
        >
          ...
          <Stack direction={"row"} spacing={1} display={{xs: "none", md: "flex"}}>
            ...
            <Button
              ...
              color="secondary"
              onClick={() =>
                handleCopyReferralLink("http://TraderConnects.net/auth/register")
              }
            >
              Copy Link
            </Button>
          ...
          {/* <Typography variant="subtitle2">
            http://TraderConnects.net/register
          </Typography> */}
        </Stack>
      </Stack>
